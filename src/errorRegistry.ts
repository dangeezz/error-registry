...
export interface ErrorRegistry<TErrorData = unknown, TError extends Error = Error> {
   ...
   * 3. Fall back to createError function if provided
 ...
 * 
 * @param config - Configuration object with seekers, createError, errors, and handlers
 ...
 *   seekers: ["code", "status"],
 *   createError: (data) => new ApiError(data),
 *   errors: {
